...
class UniversalCheckpoint(ModelCheckpoint):
    ...
    def add_argparse_args(parent_args):
        ...
        parser.add_argument('--monitor', default='BLEU-1', type=str)
        parser.add_argument('--mode', default='max', type=str)
        parser.add_argument('--save_ckpt_path', default='./ckpt/exp_gen/temp', type=str)
        parser.add_argument('--load_ckpt_path', default='./ckpt/exp_gen/temp', type=str)
